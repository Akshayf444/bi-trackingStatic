<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
    ...
    echo form_open('User/monthlyTrend', $attributes);
    ?>
    <div class="panel panel-default">
        <div class="panel-body ">
            ...
            <?php echo isset($this->Zone) ? '<input type="hidden" name="Zone" value="' . $this->Zone . '">' : ''; ?>
            <select name="Territory" disabled>
                <option value="">Select Territory</option>
                <?php echo $Territory ?>
            </select>
            <?php echo isset($this->Territory) ? '<input type="hidden" name="Territory" value="' . $this->Territory . '">' : ''; ?>
            ...
            <?php echo isset($this->Division) ? '<input type="hidden" name="Division" value="' . $this->Division . '">' : ''; ?>
            <select name="Product">
