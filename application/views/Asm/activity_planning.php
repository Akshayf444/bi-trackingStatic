                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        if (isset($_POST['rx_id']) && isset($_POST['product_id'])) {
                            $CommentExist = $this->User_model->getComment($_POST['rx_id'], 'Activity_Planning', $_POST['product_id']);
                            ?>
                            ...
                            foreach ($productlist as $product) {
                                ...
                                <div id="<?php echo $product->id ?>" class="tab-pane fade <?php echo isset($count) && $count == 1 ? 'in active' : ''; ?>">
                                    <table class="table table-bordered">
                                        ...
                                        <?php
                                        $Status = $this->asm_model->ActivityPlanningStatus($product->id, $current_month);
                                        if (!empty($Status)) {
